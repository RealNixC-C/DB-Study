...
-- 정답: 4
-- 중복 레코드를 제거하고 합치는 UNION 연산자를 사용했을 때와 결가가 같음
...
VALUES
	('이경진', 'aaa@asd', '01012345678', 'active'),
	('배동화', 'aaa@sdf', '01043215678', 'active'),
	('이혜선', 'aaa@dfg', '01012348765', 'active');
...
INSERT INTO members (name, email, phone_number, membership_status)
VALUES
	('이경진', '직원', '2025-01-22', 1000),
	('이주원', '사서', '2025-01-22', 1000),
	('박병화', '경비', '2025-01-22', 3000);
...
SELECT name, date_of_birth, address
FROM members m
LEFT JOIN member_profiles p ON m.id = p.member_id;
...
-- 정답:
-- 관계 설정 없이도 JOIN을 할 수 있단는 것을 보여줌
